...
func (_m *Interactor) CreateUser(_a0 user.User) (user.User, error) {
	ret := _m.Called(_a0)
...
func (_m *Interactor) GetUserByEmail(email string) (user.User, error) {
	ret := _m.Called(email)
...
func (_m *Interactor) GetUserById(userId int) (user.User, error) {
